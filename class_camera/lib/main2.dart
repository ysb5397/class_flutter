      ...
      child: TextButton(
        onPressed: () {
          if (iconData == Icons.camera_alt) {
            ...
            _getImage(1).then((onValue) {
              Map<String, dynamic> images = json.decode(onValue.body);
              print(images["fileName"]);
              print(images["imageData"]);
              var basedImage = images["imageData"];
              var imageBytes = base64Decode(basedImage);
